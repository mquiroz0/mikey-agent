...
console.log("API Key loaded:", process.env.REACT_APP_CLAUDE_KEY ? "YES - " + process.env.REACT_APP_CLAUDE_KEY.substring(0,15) + "..." : "NO - KEY MISSING");
...
app.post("/reply", async (req, res) => {
  ...
  try {
    ...
    console.error("CLAUDE ERROR:", JSON.stringify(err.response?.data, null, 2));
